 ...
 * Description: YITH WooCommerce EU VAT allows you to be fully in compliance with EU VAT laws, storing checkout data and filling the EU VAT MOSS report for digital goods.
 * Version: 1.2.12
 * Author: YITHEMES
...
if ( ! defined ( 'YITH_YWEV_VERSION' ) ) {
    define ( 'YITH_YWEV_VERSION', '1.2.12' );
}
