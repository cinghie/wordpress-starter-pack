...
<tr class="form-field">
	...
	<td>
		<div id="product_brand_thumbnail" style="float:left;margin-right:10px;"><img alt="<?php esc_html_e( 'Product brand thumbnail', 'yith-woocommerce-brands-add-on' ); ?>" src="<?php echo esc_html( $image ); ?>" width="60px" height="60px" /></div>
