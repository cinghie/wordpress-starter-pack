...
function include_classes() {
    ...
    if ( ! class_exists( 'WPPFM_Async_Request' ) ) { require_once ( __DIR__ . '/libraries/wppfm-async-request.php' ); }
    if ( ! class_exists( 'WPPFM_Background_Process' ) ) { require_once ( __DIR__ . '/libraries/wppfm-background-process.php' ); }
	if ( ! class_exists( 'WPPFM_Feed_Master_Class' ) ) { require_once ( __DIR__ . '/application/class-feed-master.php' ); }
	if ( ! class_exists( 'WPPFM_Feed_Controller_Class' ) ) { require_once ( __DIR__ . '/application/class-feed-controller.php' ); }
	if ( ! class_exists( 'WPPFM_Queries' ) ) { require_once ( __DIR__ . '/data/class-queries.php' ); }
	if ( ! class_exists( 'WPPFM_i18n_Scripts' ) ) { require_once ( __DIR__ . '/user-interface/class-i18n-scripts.php' ); }
    ...
    if ( ! class_exists( 'WPPFM_Email_Class' ) ) { require_once ( __DIR__ . '/application/class-email.php' ); }
}
