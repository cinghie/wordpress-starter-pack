...
if ( ! class_exists( 'WPPPFM_Attributes_List' ) ) :
	...
	class WPPPFM_Attributes_List {
		...
		/**
		 * Main elements that the Merchant Promotions feed should have.
		 *
		...
		private static $main_xml_feed_elements = array(
			'promotion_id'              => 'wpppfm_handle_reviewer',
			'product_applicability'     => 'wpppfm_handle_simple_element',
			'offer_type'                => 'wpppfm_handle_simple_element',
			'long_title'                => 'wpppfm_handle_pros',
			'promotion_effective_dates' => 'wpppfm_handle_cons',
			'redemption_channel'        => 'wpppfm_handle_review_url',
			'promotion_destination'     => 'wpppfm_handle_reviewer_images',
		);
