...
if ( ! class_exists( 'WPPPFM_Google_Merchant_Promotions_Feed_Product_Details_Wrapper' ) ) :
	...
	class WPPPFM_Google_Merchant_Promotions_Feed_Product_Details_Wrapper extends WPPFM_Filter_Wrapper {
		...
		public function display( $promotion_nr ) {
			...
			echo WPPPFM_Promotions_Details_selector_Element::promotions_details_section_start( $promotion_nr );

			echo WPPPFM_Promotions_Details_selector_Element::promotions_details_section_header();

			echo WPPPFM_Promotions_Details_selector_Element::promotions_details_content_box( $promotion_nr );

			echo WPPPFM_Promotions_Details_Selector_Element::promotions_details_section_close();
