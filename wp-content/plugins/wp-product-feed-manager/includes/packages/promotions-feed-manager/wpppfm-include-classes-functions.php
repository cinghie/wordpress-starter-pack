...
function wpppfm_include_classes() {
	...
	if ( ! class_exists( 'WPPPFM_Google_Merchant_Promotions_Feed_Page' ) ) {
		require_once __DIR__ . '/classes/class-wpppfm-google-merchant-promotions-feed-page.php';
	}
	...
	if ( ! class_exists( 'WPPPFM_Form_Element' ) ) {
		require_once __DIR__ . '/classes/elements/class-wpppfm-form-element.php';
	}
