...
if ( ! class_exists( 'WPPFM_Options_Form' ) ) :
	...
	class WPPFM_Options_Form {
		...
		private function settings() {
			...
			$html_code .= '<p><i>' . esc_html(	'WARNING: When this option is selected the system can only update one feed at a time. Make sure to deconflict your feeds auto-update schedules to prevent more than one feed auto-updates at a time.', 'wp-product-feed-manager') . '</i></p></fieldset>';
			$html_code .= '</td></tr>';
