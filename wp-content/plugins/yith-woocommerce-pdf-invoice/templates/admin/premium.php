...
<div class="landing">
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>10-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>10-icon.png" alt="icon-10" />
                    <h2><?php _e('Order tracking data','yith-woocommerce-pdf-invoice');?></h2>
                </div>
                <p><?php echo sprintf(__('By using the plugin with YITH WooCommerce Order Tracking you could insert all the %1$sorder tracking data into the delivery note.%2$s In this way, your users will receive a detailed document that will allow them to check about the shipping status.','yith-woocommerce-pdf-invoice'),'<b>','</b>');?></p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>10.png" alt=<?php _e('User information','yith-woocommerce-pdf-invoice');?>/>
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>11-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>11.png" alt= <?php _e('templates','yith-woocommerce-pdf-invoice');?>/>
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>11-icon.png" alt="Icon-09" />
                    <h2><?php _e('Credit note','yith-woocommerce-pdf-invoice');?></h2>
                </div>
                <p><?php echo sprintf(__('How many times did you have to %1$srefund an order%2$s and return the total or partial amount to the user? Thanks to YITH WooCommerce PDF Invoice and Shipping List you can generate a %1$scredit note%2$s for each refunded order. ','yith-woocommerce-pdf-invoice'),'<b>','</b>');?></p>
            </div>
        </div>
    </div>
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>12-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>12-icon.png" alt="icon-12" />
                    <h2><?php _e('Electronic invoicing for Italian companies','yith-woocommerce-pdf-invoice');?></h2>
                </div>
                <p><?php echo sprintf(__('Are you an Italian company? Are you looking for a simple way to generate the .xml file as required by the Italian Agenzia delle Entrate? <br>
Do not panic! YITH PDF Invoice includes now also a dedicated section for Italian companies, so you can comply with the Italian laws about electronic invoicing ','yith-woocommerce-pdf-invoice'),'<b>','</b>');?></p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_YWPI_ASSETS_IMAGES_URL ?>12.png" alt=<?php _e('Electronic invoicing for Italian companies','yith-woocommerce-pdf-invoice');?>/>
            </div>
        </div>
    </div>
    <div class="section section-cta section-odd">
