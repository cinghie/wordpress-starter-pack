	...
	<div class="section section-cta section-odd">
		<div class="landing-container">
			<div class="premium-cta">
				<p>
					<?php echo wp_kses_post( sprintf( __( 'Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Request a Quote%2$s to benefit from all features!', 'yith-woocommerce-request-a-quote' ), '<span class="highlight">', '</span>' ) ); ?>
				</p>
	...
	<div class="three section section-even clear">
		<div class="landing-container">
			...
			<div class="col-2">
				<div class="section-title">
					<h2><?php esc_html_e( '
Customize the button colors and texts', 'yith-woocommerce-request-a-quote' ); ?></h2>
				</div>
				<p>
	...
	<div class="eight section section-odd clear">
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php  esc_html_e( '
If you don’t want to use the default form, the plugin however supports Gravity Forms and Contact Form 7.', 'yith-woocommerce-request-a-quote' ); ?>
				</p>
			</div>
			<div class="col-1">
	...
	<div class="eleven section section-even clear">
		<div class="landing-container">
			...
			<div class="col-2">
				<div class="section-title">
					<h2><?php esc_html_e( '
Edit the product prices and add shipping fees, extra costs or coupon codes to the quote', 'yith-woocommerce-request-a-quote' ); ?></h2>
				</div>
				<p>
	...
	<div class="eleven section section-even clear">
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php  esc_html_e( '
Thanks to the “Quotes” section in My Account page, users will be able to monitor the status of their quote requests, download the PDF version of the quote (if enabled) and view the details of every quote request.', 'yith-woocommerce-request-a-quote' ); ?>
				</p>
			</div>
		</div>
	</div>
	...
	<div class="section section-cta section-odd">
		<div class="landing-container">
			<div class="premium-cta">
				<p>
					<?php echo sprintf( esc_html( __( 'Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Request a Quote%2$s to benefit from all features!', 'yith-woocommerce-request-a-quote' ) ), '<span class="highlight">', '</span>' ); ?>
				</p>
				<a href="<?php echo esc_url( $this->get_premium_landing_uri() ); ?>" target="_blank"
					class="premium-cta-button button btn">
					<?php esc_html_e( 'UPGRADE', 'yith-woocommerce-request-a-quote' ); ?>
