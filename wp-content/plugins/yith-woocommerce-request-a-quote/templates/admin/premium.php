    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWRAQ_URL ?>assets/images/04-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf( __( 'A dedicated list where you can add those products that have to be excluded from quote requests. Enable the specific option and "Add to Quote" button will %snot be displayed%s for products in this table.%3$sAnd if you have to remove all products in a %1$scategory%2$s or %1$stag%2$s, you can do this with one click and the exclusion will apply also to all products you will add later.','yith-woocommerce-request-a-quote' ),'<b>','</b>','<br>' );?></p>
            </div>
            <div class="col-1">
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWRAQ_URL ?>assets/images/06-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf( __('The plugin includes an advanced default form. Thanks to it, you can %1$scustomize%2$s it and add %1$sas many fields as you wish%2$s. Add a date or picker, an upload field, checkboxes or radio buttons, select or multi selects, text, heading, state and country fields. Feel free to compose it as you prefer.
Yet, if you’re already using %1$s"Contact Form 7", "Gravity Form"%2$s or %1$s"YITH Contact Form"%2$s, feel free to build your form with those, as they are all supported.','yith-woocommerce-request-a-quote'),'<b>','</b>','<br>' );?></p>
            </div>
            <div class="col-1">
    ...
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWRAQ_URL ?>assets/images/12-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWRAQ_URL ?>assets/images/12.png" alt="PDF Attachment" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWRAQ_URL?>assets/images/12-icon.png" alt="icon 12" />
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWRAQ_URL ?>assets/images/13-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWRAQ_URL ?>assets/images/13.png" alt="Widget" />
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('LOGO, SENDER AND FOOTER IN PDF','yith-woocommerce-request-a-quote');?></h2>
                </div>
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWRAQ_URL ?>assets/images/25-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf( __('And that\'s not all! You can also prevent the users from editing the checkout fields and avoid changes of the data previously inserted.','yith-woocommerce-request-a-quote'),'<b>','</b>'); ?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('QUICK CHECKOUT','yith-woocommerce-request-a-quote');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('You made the proposal to the user who decides to accept it. What happens now? %1$sThe most logical thing!%2$s The user is redirected to the checkout page to complete the order according to the quote received. Easy and fast.','yith-woocommerce-request-a-quote'),'<b>','</b>' );?>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWRAQ_URL ?>assets/images/29-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWRAQ_URL ?>assets/images/29-icon.png" alt="icon 29" />
                    <h2><?php _e('Match WooCommerce checkout fields','yith-woocommerce-request-a-quote');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('If you %1$smatch the form fields with WooCommerce standard information%2$s, you can have them automatically filled in the quote request you receive on backend and in the checkout for users, so they don’t have to add their details once again.','yith-woocommerce-request-a-quote'),'<b>','</b>'); ?>
                </p>
                <p>
                    <?php echo sprintf( __('And there\'s more: enable the %1$sauto-complete option%2$s and they will automatically see their own details filled in if they are logged in','yith-woocommerce-request-a-quote'),'<b>','</b>' );?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_YWRAQ_URL ?>assets/images/29.png" alt="" />
            </div>
        </div>
    </div>
