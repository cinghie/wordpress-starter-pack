    ...
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Multi-step Checkout%2$s to benefit from all features!','yith-woocommerce-multi-step-checkout'),'<span class="highlight">','</span>' );?>
                </p>
                <a href="<?php echo $this->get_premium_landing_uri() ?>" target="_blank" class="premium-cta-button button btn">
                    <span class="highlight"><?php _e('UPGRADE','yith-woocommerce-multi-step-checkout');?></span>
                    <span><?php _e('to the premium version','yith-woocommerce-multi-step-checkout');?></span>
                </a>
            </div>
        </div>
    </div>
    <div class="one section section-even clear">
        <h1><?php _e('Premium Features','yith-woocommerce-multi-step-checkout');?></h1>
        <div class="landing-container">
            <div class="col-1">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Display styles','yith-woocommerce-multi-step-checkout');?></h2>
                </div>
                <p>
                    <?php echo sprintf(__('4 different types to shape your site checkout steps. %1$s4 different layouts%2$s  to let you find the best solution for you and the most suitable for the graphic style of your pages.%3$sBut, this is not all! Opt for %1$svertical display%2$s if you want to show all steps as if they were all elements belonging to a sidebar.', 'yith-woocommerce-multi-step-checkout'), '<b>', '</b>','<br>');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('“My account” and “Order received” pages','yith-woocommerce-multi-step-checkout');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __( 'A section of your option panel devoted to customisation of color patterns of “My account” and “Order received” pages, or better the page where users are redirected after completing purchase.%3$s%1$sYITH WooCommerce Multi-step Checkout%2$s has thought of everything!','yith-woocommerce-multi-step-checkout' ),'<b>','</b>','<br>' ) ?>
                </p>
            </div>
            <div class="col-1">
