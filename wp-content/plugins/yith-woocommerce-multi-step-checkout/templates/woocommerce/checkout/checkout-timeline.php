...
<ul id="checkout_timeline"
	class="woocommerce_checkout_timeline <?php echo $display ?> <?php echo $style ?> <?php echo $shipping_step_enabled ? '' : 'shipping_removed'; ?>">
	<?php if ( $show_login_step ) : ?>
		<li id="timeline-login" data-step="login"
			class="timeline login <?php echo ! $is_user_logged_in ? 'active' : ''; ?>">
	...
	<?php endif; ?>
	<li id="timeline-billing" data-step="billing"
		class="timeline billing <?php echo ! $show_login_step ? 'active' : ''; ?>">
		<div class="timeline-wrapper">
